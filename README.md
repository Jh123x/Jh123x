...
-    [Jh123x/jh123x.github.io: refactor: update code and spaces.](https://github.com/Jh123x/jh123x.github.io/pull/57) (MERGED): Website to Show my projects / competitions (today)

-    [Jh123x/buildergen: refactor: refactor buildergen](https://github.com/Jh123x/buildergen/pull/15) (OPEN): Buildergen is a code generation tool to create a builder class for generating structs (2 days ago)
