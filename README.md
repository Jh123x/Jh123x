...
- [Jh123x/buildergen](https://github.com/Jh123x/buildergen) ([v0.1.0](https://github.com/Jh123x/buildergen/releases/tag/v0.1.0), 1 week ago) - Buildergen is a code generation tool to create a builder class for generating structs
...
-    [Jh123x/buildergen: feat: add yaml file support for code generation](https://github.com/Jh123x/buildergen/pull/8) (OPEN): Buildergen is a code generation tool to create a builder class for generating structs (2 days ago)
