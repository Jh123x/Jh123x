...
-    [Jh123x/jh123x.github.io: refactor: update code and spaces.](https://github.com/Jh123x/jh123x.github.io/pull/57) (MERGED): Website to Show my projects / competitions (2 days ago)

-    [Jh123x/buildergen: refactor: refactor buildergen](https://github.com/Jh123x/buildergen/pull/15) (OPEN): Buildergen is a code generation tool to create a builder class for generating structs (4 days ago)
...
- [Building a Data Converter That Eliminates 4 Clicks per Task](https://jh123x.com/blog/2026/building-a-data-converter/) (1 week ago)
