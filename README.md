...
- [Oudwins/zog](https://github.com/Oudwins/zog) ([v0.22.0](https://github.com/Oudwins/zog/releases/tag/v0.22.0), 2 days ago) - Go with Zod inspired simple schema validation
...
-    [Jh123x/buildergen: feat: allow destination to be any location](https://github.com/Jh123x/buildergen/pull/14) (OPEN): Buildergen is a code generation tool to create a builder class for generating structs (2 weeks ago)
...
- [Coolify Wildcard Subdomain Setup With Cloudflare](https://jh123x.com/blog/2025/coolify-wildcard-subdomain-setup-with-cloudflare/) (2 weeks ago)
- [Databases: Differences between different database variants](https://jh123x.com/blog/2025/databases---difference-between-database-variants/) (4 weeks ago)
