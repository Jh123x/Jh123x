...
-    [Oudwins/zog: feat: partial feature implementation](https://github.com/Oudwins/zog/pull/157) (OPEN): Go with Zod inspired simple schema validation (5 days ago)

-    [Oudwins/zog: feat: add other not operators](https://github.com/Oudwins/zog/pull/155) (OPEN): Go with Zod inspired simple schema validation (5 days ago)
