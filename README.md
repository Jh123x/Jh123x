...
- [Oudwins/zog](https://github.com/Oudwins/zog) ([v0.21.1](https://github.com/Oudwins/zog/releases/tag/v0.21.1), 1 week ago) - Go with Zod inspired simple schema validation
...
-    [Oudwins/zog: feat: partial feature implementation](https://github.com/Oudwins/zog/pull/157) (OPEN): Go with Zod inspired simple schema validation (3 weeks ago)

-    [Oudwins/zog: feat: add other not operators](https://github.com/Oudwins/zog/pull/155) (MERGED): Go with Zod inspired simple schema validation (3 weeks ago)
