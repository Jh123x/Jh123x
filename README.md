...
- [Jh123x/buildergen](https://github.com/Jh123x/buildergen) ([v0.2.0](https://github.com/Jh123x/buildergen/releases/tag/v0.2.0), 2 days ago) - Buildergen is a code generation tool to create a builder class for generating structs
...
-    [Jh123x/buildergen: feat: add yaml file support for code generation](https://github.com/Jh123x/buildergen/pull/8) (MERGED): Buildergen is a code generation tool to create a builder class for generating structs (4 days ago)
