...
- [Oudwins/zog](https://github.com/Oudwins/zog) - Go with Zod inspired simple schema validation (5 days ago)
...
- [Oudwins/zog](https://github.com/Oudwins/zog) ([v0.21.1](https://github.com/Oudwins/zog/releases/tag/v0.21.1), 5 days ago) - Go with Zod inspired simple schema validation
...
-    [Oudwins/zog: feat: add other not operators](https://github.com/Oudwins/zog/pull/155) (MERGED): Go with Zod inspired simple schema validation (2 weeks ago)
...
- [Consolidating all my pages.](https://jh123x.com/blog/2025/page-consolidation/) (1 month ago)
