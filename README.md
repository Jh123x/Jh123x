...
- [Jh123x/buildergen](https://github.com/Jh123x/buildergen) ([v0.0.2](https://github.com/Jh123x/buildergen/releases/tag/v0.0.2), 3 days ago) - Buildergen is a code generation tool to create a builder class for generating structs
...
-    [jpanther/congo: fix: fix unsafe url](https://github.com/jpanther/congo/pull/901) (OPEN): A powerful, lightweight theme for Hugo built with Tailwind CSS. (2 months ago)
