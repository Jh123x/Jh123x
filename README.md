...
- [Jh123x/bootdev-pokedex](https://github.com/Jh123x/bootdev-pokedex) -  (5 days ago)
...
-    [Oudwins/zog: feat: add not operator](https://github.com/Oudwins/zog/pull/76) (OPEN): Go with Zod inspired simple schema validation (2 days ago)
