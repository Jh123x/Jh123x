...
- [Oudwins/zog](https://github.com/Oudwins/zog) - Go with Zod inspired simple schema validation (6 days ago)
...
- [Oudwins/zog](https://github.com/Oudwins/zog) ([v0.21.1](https://github.com/Oudwins/zog/releases/tag/v0.21.1), 6 days ago) - Go with Zod inspired simple schema validation
