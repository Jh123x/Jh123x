...
- [Jh123x/buildergen](https://github.com/Jh123x/buildergen) ([v0.0.1](https://github.com/Jh123x/buildergen/releases/tag/v0.0.1), today) - Buildergen is a code generation tool to create a builder class for generating structs
